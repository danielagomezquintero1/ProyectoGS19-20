              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#"> |
                    ...
                    $sql2 =$conn->query("SELECT * FROM publicaciones WHERE user='".$result['id']."'");
                    $result2=$sql2->num_rows;

                    //mostrar seguidores

                    $sql3 =$conn->query("SELECT * FROM seguidores WHERE seguido='".$result['id']."'");
                    $result3=$sql3->num_rows;

                    $sql4 =$conn->query("SELECT * FROM seguidores WHERE seguidor='".$result['id']."'");
    ...
    <div class="col-12"style="background-color: white;">
      <div class="row">
        ...
        <div class="col-5" style="text-align: center; margin-top:9%;">
          <a class="btn btn-outline-primary" href="subir.php" role="button">Sube un post</a>
        </div>
      </div>
    </div>
</div>
    ...
    <div class="row mt-5">
      <div class="col-12 p-3 m-2" style="background-color: white;">
        ...
        while($publicaciones = $sql2->fetch_array()) {
          $sql4 = $conn->query("SELECT * FROM archivos WHERE publicacion ='".$publicaciones['id']."'");
          $result4 = $sql4->fetch_array();
          ?>
          <img class="m-3 view_data"name="view" value="view" id="<?php echo $result['id']; ?>" data-toggle="modal" style="width:29%"src='archivos/<?php echo $result4['ruta']; ?>');>
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title">Detalles de la imagen seleccionada</h4>  
                </div>  
