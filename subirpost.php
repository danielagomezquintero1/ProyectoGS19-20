    ...
    <div class="container">
      <div class="row pt-5">
        <div class="col-12 p-5" style="background-color: white; text-align:center;">
          ...
          <div class="col-12 mt-4">
           <b>Título de la canción (<i>url</i>)</b>
         </div>
         <div class="col-12 mt-3">
...
if (isset($_POST['submit'])) {  
  ...
  $queryp = $mysqli->query("INSERT INTO publicaciones (user,descripcion,ubicacion,fecha, titulo, nombreuser) VALUES ('".$_SESSION['id']."','".$ruta."','".$cancion."',now(),'".$titulo."','".$_SESSION['user']."')");
