  ...
  $yaExiste = $mysqli->query("SELECT * FROM seguidores WHERE seguidor='".$_SESSION['id']."'");
   ...
   if($yaEnviaste>0){
   ...
   }  else
    {
        ...
        if($sqlG){
          header("Location:buscar_usuarios.php?busqueda=".$_REQUEST['busqueda']."");
         }
      } 
...
<?php
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Perfil de <?php echo $rowA["username"]; ?></p></li>
  </ol>
</nav>    
            ...
            <div class="col-5 mt-3">
              <div class="row">
               ...
               <?php } else{ //SI el perfil es de otro usuario, saldra, seguir  ?>
                  <div class="d-none d-lg-block col-lg-5 mt-3 ml-5">
                    <!--boton seguir-->
                    <?php if($yaEnviaste > 0){  ?>
                      <button class="btn btn-light btn-sm">Le sigues</button>
                    <?php }  else{ ?>
                      <a href="?seguir=seguir&busqueda=<?php echo $_REQUEST['busqueda']; ?>"><div class="mt-3"><button class="btn btn-info btn-sm">Seguir</button></div></a>
                  <?php } ?>
                  </div>
                <?php }  ?>
                <div class="col-12">
